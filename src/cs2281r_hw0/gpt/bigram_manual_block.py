...
class BigramLanguageModel(nn.Module):
    ...
    def forward(
        ...
        # combined_embeddings = self.self_attention_heads(
        #     combined_embeddings
        # )  # Apply one head of self-attention. (B, T, C)
        # combined_embeddings = self.feed_forward_network(combined_embeddings)
